...
void make_tau3mu_shapes(int seed=37)
{
  ...
  RooRealVar *p0 = new RooRealVar("pol2_p0","p_0",0.5,0,1,"");
  p0->setConstant(kFALSE);
  RooRealVar *p1 = new RooRealVar("pol2_p1","p_1",0.5,0,1,"");
  ...
  TFile file("/afs/cern.ch/user/x/xuyan/3MuonProj/CMSSW_8_0_27/src/Ntuples/dstau_Tau3Mu_select_closest_tritriobjcut.root");
